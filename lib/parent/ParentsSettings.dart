...
import 'ParentProfileView.dart';

class ParentsSettings extends StatefulWidget {
  const ParentsSettings({Key? key}) : super(key: key);

  @override
  State<ParentsSettings> createState() => _ParentsSettingsState();
}

class _ParentsSettingsState extends State<ParentsSettings> {
  ...
  Widget build(BuildContext context) {
    ...
    padding: const EdgeInsets.only(top: 410),
      ...
      child: OutlinedButton(
        ...
        onPressed: () {
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> ParentProfileView()));
        },
      ),
    ), SizedBox(
    width: 30,
