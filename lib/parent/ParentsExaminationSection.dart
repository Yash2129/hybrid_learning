...
class ParentsExaminationSection extends StatefulWidget {
  const ParentsExaminationSection({Key? key}) : super(key: key);

  @override
  State<ParentsExaminationSection> createState() => _ParentsExaminationSectionState();
}

class _ParentsExaminationSectionState extends State<ParentsExaminationSection> {
  @override
